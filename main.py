...
def attack(char_name: str, char_class: str) -> str:
    """Выполняет атаку на основе класса персонажа.
...
def defence(char_name: str, char_class: str) -> str:
    """Выполняет защиту на основе класса персонажа.
...
def special(char_name: str, char_class: str) -> str:
    """Выполняет специальное действие (суперсила) на основе класса персонажа.
    ...
    Возвращает:
    str: Сообщение о специальном действии.
    """
    if char_class == 'warrior':
